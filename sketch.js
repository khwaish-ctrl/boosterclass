...
var conImage,gameoverImage,gameover 
...
syringe.shapeColor="black"
 ...
 createbutton=createSprite(displayWidth/2-200,displayHeight/2-100,50,50)
...
if(gameState==="end"){
  ...
  if(life>0){
    stroke("yellow")
    textSize(35)
    text("You are left with " +life+"!!!",windowWidth/2-100,windowHeight/2)
